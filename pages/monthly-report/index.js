...
const MonthlyReport = () => {
    ...
    const [searchTerm, setSearchTerm] = useState(""); // Used for filter section
    const [tableSearchTerm, setTableSearchTerm] = useState(""); // New state for table search
    ...
    const handleReset = () => {
        ...
        setSelectedGroup([]);
        setSearchTerm("");
        setTableSearchTerm(""); // Reset table search
        setFileName("");
        setUploadMessage("");
    };
    ...
    const getSortedIndices = (indices) => {
        ...
        return [...sortItems(qodeStrategies), ...sortItems(others)];
    };
    ...
    // Add table-specific search filtering
